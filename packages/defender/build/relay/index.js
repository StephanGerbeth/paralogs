...
async function handler(event) {
  ...
  if (type === 'permit') {
    ...
    tx = await relayTokenApproval(permitContract, request);
...
var metaTransactions$1 = /*@__PURE__*/getDefaultExportFromCjs(metaTransactions);

module.exports = metaTransactions$1;
